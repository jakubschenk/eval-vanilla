...
<body>
    ...
    <nav class="navbar navbar-dark py-2">
        ...
        <div class="form-inline px-2">
            ...
            <a href="/administrace/logout" class="btn mx-auto btn-outline-secondary text-white" id="logout">
    ...
    <main>
        ...
        if(!file_exists('client_secrets.json')) {
            ?>
                ...
                Chybí konfigurační soubor 'client_secrets.json' stáhněte jej podle pokynů instalačního dokumentu <a href="https://console.cloud.google.com" class="alert-link">zde</a>!
                </div>
            <?php
        }
        ?>